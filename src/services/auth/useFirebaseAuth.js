...
export default function useFirebaseAuth(){ 
    ...
    const changePassword = async (currentPassword, newPassword) => {
        try {
          ...
          toast.error(error, { toastId: "firebase-change-password-error" });
    ...
    const forgotPassword = async (email) => {
        ...
        toast.success("Reset password has been sent to your email successfully.", {
    ...
    const signInWithGoogle = async () => {
        try{
            ...
            return {status: true, user: auth.currentUser, token: token, isFirstSignIn: isFirstSignIn, expiryTime};
        }
        catch(e){
            const error = firebaseErrorFinder[e.code]?firebaseErrorFinder[e.code]:"Somthing went wrong during authentication please refresh and retry";
            toast.error(error,{
