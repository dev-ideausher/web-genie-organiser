...
import { getvideo,deletevideo,updatevideo } from "../../services/APIs/Video";
...
export default function videoSection() {
  ...
  const handleRename = async () => {
    try {
      await updatevideo(renameId, { title: renameValue });
      setRenameId(null);
      setRenameValue("");
      fetchvideos();
    } catch (err) {
  ...
  return (
    <div className="p-8">
      ...
      {renameId && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-96">
            <h3 className="font-semibold mb-4">Rename video</h3>
            <input
              value={renameValue}
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-96">
            <h3 className="font-semibold mb-3">Delete video</h3>
