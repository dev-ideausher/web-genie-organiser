    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        ...
        <div className="bg-white p-5 rounded-2xl shadow-md">
          <h2 className="font-semibold text-lg mb-4 flex gap-1 items-center "><IdeaBulb/>Daily Affirmations</h2>
          {[1, 2, 3].map((i) => (
        ...
        {/* My Own Affirmations */}
        <div className="bg-white p-5 rounded-2xl shadow-md">
          <h2 className="font-semibold text-lg mb-4 flex gap-1 items-center "><Notes/>My Own Affirmations</h2>
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
        ...
        {/* Add Affirmations */}
        <div className="bg-white p-5 rounded-2xl shadow-md">
          <h2 className="font-semibold text-lg mb-4 flex gap-1 items-center "><Notes/>Add Affirmations</h2>
